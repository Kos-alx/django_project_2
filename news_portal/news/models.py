...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        for post in posts:
            commentAuthRat = post.comment_set.all().aggregate(commentAuthorRating=Sum('rating'))
            if commentAuthRat.get('commentAuthorRating'):
                caRat += commentAuthRat.get('commentAuthorRating')
